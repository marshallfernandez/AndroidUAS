package com.puntobat.uas.controller.intent;
...
public class HTTPConnector {
	...
	public String getRESTWithToken(String urlString) {
		httpGet = new HttpGet(urlString);
		httpGet.setHeader("Authorization", "Bearer " + FrameworkConstans.TOKEN);
		//Log.e("WebGetURL: ", urlString);
